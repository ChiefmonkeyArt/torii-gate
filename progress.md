...
> Current version: **v0.2.180-alpha** | Live: [torii-quest.pplx.app](https://torii-quest.pplx.app)
...
| Metric | Value |
|---|---|
| Source version | **v0.2.180-alpha** (build truth; live trails — manual maintainer deploy) |
...
| Active slice | v0.2.180 LEAN-2 in-world gateway PORTAL activation seam — maps a gateway component to a confirmed same-origin `/zone` hop (arm→confirm), injected transport only, scoped allowlist never `['/']`; pure/inert, no live navigation |
