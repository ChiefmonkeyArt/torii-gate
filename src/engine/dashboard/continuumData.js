...
export const CONTINUUM_VERSION = 'v0.2.198-alpha';
...
export const CONTINUUM = Object.freeze({
  ...
  // "At a glance" metrics.
  metrics: [
    { label: 'Source version', value: 'v0.2.198-alpha (build truth; live trails — manual deploy)' },
    { label: 'Tests', value: '1228 passing / 77 files (profiles: test:fast ~5, test:foundation ~25)' },
