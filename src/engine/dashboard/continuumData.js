...
export const CONTINUUM_VERSION = 'v0.2.316-alpha';
...
// These mirror the most recent committed LIVE_SMOKE_STATE.json (app-entry, v0.2.316-alpha PASS
// 3/3) and DASHBOARD_SMOKE_STATE.json (oversight dashboard, v0.2.316-alpha PASS 4/4). The smoke
...
const HANDOFF_LASTKNOWN_ENTRY_SMOKE = Object.freeze({
  result: 'pass', pass: true, version: 'v0.2.316-alpha', checks: 3, passed: 3, failed: 0,
});
const HANDOFF_LASTKNOWN_DASHBOARD_SMOKE = Object.freeze({
  result: 'pass', pass: true, version: 'v0.2.316-alpha', checks: 4, passed: 4, failed: 0,
});
...
export const CONTINUUM = Object.freeze({
  ...
  // "At a glance" metrics.
  metrics: [
    { label: 'Source version', value: 'v0.2.316-alpha (build truth; live trails — manual deploy)' },
    ...
    { label: 'Smoke (entry + dashboard)', value: 'Both cloud smokes consolidated into the Handoff / release control panel at the top of this page — app-entry v0.2.316-alpha PASS 3/3, oversight-dashboard v0.2.316-alpha PASS 4/4. A smoke pass does not imply MVP approval or a completed human playtest.' },
