...
// handoffControlPanel: moved to src/sdk/dashboard.js (R1 completed, v0.2.292) — a
...
export const SDK_SURFACE = Object.freeze({
  ...
  // PURE approach-affordance view-model (v0.2.292) — grades player proximity into
  ...
  // v0.2.292) — Continuum/build-only oversight surface; no game-runtime importer.
