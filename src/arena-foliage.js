...
function _buildGrass() {
  ...
  const stamp = `[grass-build] v0.2.282 blades=${count} bladeW=${BLADE_W} bladeH=${BLADE_H} flare=5.6 lean=0.22 sink=-0.05 groundCover=0x3d5a2f windGust=0.34 tall21pct=×1.21Y tip=point`;
  console.info(stamp);
