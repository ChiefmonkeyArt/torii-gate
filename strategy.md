...
### 15-Hour Proof-of-Concept Route (ACTIVE — v0.2.138)
...
2. **Gateway / NAP-to-NAP preview** — a spatial handoff between two instances via
   ...
   `gatewayPortal.js` (portal VIEW shell landed v0.2.136); relay-mediated first
   (see Nostr Spatial Gateway Protocol).
