...
> Live site: [torii-quest.pplx.app](https://torii-quest.pplx.app) | Current version: **v0.2.167-alpha**
...
- **The active MVP is the freedom-tech loop**, four demonstrable slices:
  1. **Gateway / NAP-to-NAP preview** — the Torii Gateway portal view + travel-intent
     ...
     reload/unload/sign/publish method). Real relay read transport, the in-world
     gateway/destination MESH, the clickable confirm dialog that MINTS a grant, and the first
     controlled local/same-site travel that ACTS on a ready plan (v0.2.168) remain the
