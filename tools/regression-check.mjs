// tools/regression-check.mjs — static smoke/regression guardrails (v0.2.123).
...
const EXPECTED_VERSION = 'v0.2.123-alpha';
...
console.log(`[5] version markers == ${EXPECTED_VERSION}`);
{
  ...
  if (/v0\.2\.122-alpha/.test(html)) fail('index.html still references v0.2.122-alpha');
}
