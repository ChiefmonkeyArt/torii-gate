...
> generated: 2026-06-26T09:03:39.694Z

- **Verdict:** NEAR
- **Version:** v0.2.221-alpha @ f78a2bc (source)
- **package.json:** 0.2.221-alpha
- **Live:** https://torii-quest.pplx.app

## Prerequisites

- ✓ Current version stamped (config.js VERSION) — _ok_: v0.2.221-alpha
- ✓ config VERSION matches package.json — _ok_: v0.2.221-alpha == v0.2.221-alpha
...
git tag -a v0.2.221-alpha -m "Torii Quest v0.2.221-alpha (MVP proof)"
# publish the tag — DO NOT run without user approval
git push origin v0.2.221-alpha
# create the GitHub release — DO NOT run without user approval
gh release create v0.2.221-alpha --notes-file RELEASE_NOTES_DRAFT.md --title "Torii Quest v0.2.221-alpha"
```
