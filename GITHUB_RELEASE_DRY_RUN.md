...
> generated: 2026-06-26T03:41:39.097Z

- **Verdict:** NEAR
- **Version:** v0.2.213-alpha @ 76664db (source)
- **package.json:** 0.2.213-alpha
- **Live:** https://torii-quest.pplx.app

## Prerequisites

- ✓ Current version stamped (config.js VERSION) — _ok_: v0.2.213-alpha
- ✓ config VERSION matches package.json — _ok_: v0.2.213-alpha == v0.2.213-alpha
...
git tag -a v0.2.213-alpha -m "Torii Quest v0.2.213-alpha (MVP proof)"
# publish the tag — DO NOT run without user approval
git push origin v0.2.213-alpha
# create the GitHub release — DO NOT run without user approval
gh release create v0.2.213-alpha --notes-file RELEASE_NOTES_DRAFT.md --title "Torii Quest v0.2.213-alpha"
```
