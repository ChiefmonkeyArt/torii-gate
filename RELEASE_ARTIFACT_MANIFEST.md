...
> generated: 2026-06-26T09:03:42.275Z

- **Status:** COMPLETE
- **Version:** v0.2.221-alpha @ f78a2bc (source)
- **Package version:** 0.2.221-alpha
...
| --- | --- | --- | --- | --- | --- |
| `RELEASE_NOTES_DRAFT.md` | MVP release notes (DRAFT) | doc | present | `e80060254d74` | 2842 |
| `MVP_RELEASE_PACKAGE.md` | MVP release package index | doc | present | `5d66067e778e` | 2096 |
| `GITHUB_RELEASE_DRY_RUN.md` | GitHub release dry-run | doc | present | `41a6dcedf55c` | 2578 |
| `public/release-metadata.json` | Build / release metadata (served) | build-metadata | present | `5c23385bcf24` | 1158 |
| `package.json` | Package manifest (version + scripts) | config | present | `214b569204b9` | 1876 |
| `index.html` | App entry (version-stamped) | config | present | `444cdcb0cdb7` | 37374 |

## Optional artifacts

| Artifact | Label | Category | Present | sha256 | Bytes |
| --- | --- | --- | --- | --- | --- |
| `MVP_RC_SNAPSHOT.md` | MVP RC freeze-candidate snapshot | doc | present | `020975005776` | 4100 |
| `MVP_PLAYTEST_CHECKLIST.md` | MVP playtest checklist | doc | present | `e50e22c51eaf` | 11004 |
| `MVP_PLAYTEST_RESULTS_TEMPLATE.md` | MVP playtest results template | doc | present | `4b83fe6c422d` | 8581 |
| `HANDOFF.md` | Handoff narrative (source of truth) | doc | present | `57a374348bc1` | 105108 |
| `VPS_INSTALL.md` | VPS install / manual deploy notes | doc | present | `05127e4b7b25` | 22754 |
| `public/continuum-data.json` | Continuum dashboard data (served) | build-metadata | present | `6b2dfb6a23e7` | 17670 |
